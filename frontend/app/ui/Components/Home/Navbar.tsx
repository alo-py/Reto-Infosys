      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            <Link
              href="/"
              className="text-white hover:bg-slate-200/30 hover:text-gray-800 p-2 rounded-lg text-sm font-medium transition-colors"
            >
              Home
            </Link>
              ...
              <>
                ...
                <div className="flex items-center gap-2 pl-2 border-l border-white/20">
                  ...
                  <button
                    ...
                    title="Sign Out"
                    className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-white hover:bg-rose-500/20 hover:text-rose-200 transition-colors text-xs font-semibold cursor-pointer border border-white/10"
                  >
